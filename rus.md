...
создаете треугольник или трапецию с помощью CSS, то созданная форма не
влияет на то, как будет вести себя текст внутри фигуры или вокруг.
...
системы координат. Мы установим высоту, равную высоте контейнера, который я для этого примера создала равным высоте вьюпорта, используя единицу измерения `vh`.
