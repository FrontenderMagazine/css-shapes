...
>В то время как мы можем ограничивать строчный контент с помощью shapes (форм) реальный его контейнер не изменяется. Если элемент имеет конкретные внешние и внутренние отступы, границы, то они будут рассчитаны в соответствии с [CSS3BOX][7]. — [W3C CSS Shapes Module Level 1][8] 
