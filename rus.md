...
Сегодня вы можете создавать любые виды форм при помощи [css-трансформаций][1], но эти формы не могут влиять на поведение контента внутри них или вокруг них. Например, если вы создаете треугольник или трапецию посредством CSS, то созданная форма не определяет и не влияет на то как будет вести себя текст внутри фигуры или вне ее. 
...
![Скриншот демо #1. Нажмите на скриншот чтобы увидеть работающее демо][16]
...
[Скриншот показывает вершины, которые образуют форму многоугольника][17]
